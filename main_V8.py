    ...
    def check_answer(self, user_answer):
        ...
        if self.selected_difficulty in ["Hard", "Challenge"]:
            try:
                ...
                if user_expr - correct_expr == 0:
                    user_answer = correct_answer
            except Exception as e:
                print("Hey") # DEBUGGING AND WILL REMOVE LATER.
...
class WelcomeScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Create title label.
        title_label = ttk.Label(title_frame, text="Welcome!", font=("Berlin Sans FB", 75))
        title_label.pack()

        # Create subheader.
        subheader_text = ttk.Label(title_frame, text="You may log in to your account, or sign up if you don't have one.", font=("Cambria", 25))
...
class LoginScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Create title label.
        title_label = ttk.Label(title_frame, text="Login", font=("Berlin Sans FB", 50))
        title_label.pack()

        # Create subheader.
        subheader_text = ttk.Label(title_frame, text="Please enter your correct account details.", font=("Cambria", 25))
        subheader_text.pack(pady=5)
        ...
        username_label = ttk.Label(login_frame, text="Username:", font=("Cambria", 30))
        username_label.grid(row=0, column=0, padx=10, pady=25, sticky="e")

        # Username entry field.
        self.username_entry = ttk.Entry(login_frame, font=("Cambria", 30), width=25, validate="key", validatecommand=(controller.username_limit, "%P"))
        self.username_entry.grid(row=0, column=1, padx=10, pady=25)

        # Password entry label.
        password_label = ttk.Label(login_frame, text="Password:", font=("Cambria", 30))
        password_label.grid(row=1, column=0, padx=10, pady=(0, 25), sticky="e")

        # Password entry field.
        self.password_entry = ttk.Entry(login_frame, font=("Cambria", 30), width=25, show="*", validate="key", validatecommand=(controller.password_limit, "%P"))
        self.password_entry.grid(row=1, column=1, padx=10, pady=(0, 25))
...
class SignupScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Create title label.
        title_label = ttk.Label(title_frame, text="Sign Up", font=("Arial", 50))
        title_label.pack()

        # Create subheader.
        subheader_text = ttk.Label(title_frame, text="Please enter a username and a strong password.", font=("Arial", 25))
        subheader_text.pack(pady=5)
        ...
        controller.style.configure("Signup.TButton", font=("Arial", 30), background="#FFFFFF")
...
class LobbyScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Create title label.
        title_label = ttk.Label(title_frame, text="Select a Difficulty Level", font=("Berlin Sans FB", 50))
        title_label.pack()

        # Create username label.
        self.username_label = ttk.Label(title_frame, font=("Cambria", 25))
...
class InstructionsScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Create title label.
        title_label = ttk.Label(self, text="How To Play", font=("Berlin Sans FB", 50))
        ...
        instructions_header = ttk.Label(topbar, text="Instructions", font=("Arial", 25))
        instructions_header.pack(pady=5)

        # Create instructions text (goes in contents frame).
        self.instructions_text = ttk.Label(contents_frame, font=("Cambria", 15), wraplength=975, justify="left")
...
class QuizScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Create title label.
        title_label = ttk.Label(self, text="Gameplay", font=("Berlin Sans FB", 50))
        title_label.pack(pady=50)
        ...
        self.confirm_label = ttk.Label(self, text="Confirm quit? Progress will not be saved!", font=("Cambria", 25))
        ...
        #Create frame for main contents.
        main_frame = tk.Frame(self, width=1200, height=650)
        main_frame.pack()
        main_frame.pack_propagate(False)
        main_frame.grid_propagate(False)
        ...
        self.lives_label = ttk.Label(lives_frame, text="Lives:", font=("Arial", 20))
        ...
        self.question_num = ttk.Label(topbar, font=("Arial", 25))
        ...
        self.question_instruction = ttk.Label(contents_frame, font=("Cambria", 30))
        self.question_instruction.grid(row=0, column=0, pady=10)

        # Create question label.
        self.question_label = ttk.Label(contents_frame, font=("Cambria", 50))
        self.question_label.grid(row=1, column=0, pady=100)
        ...
        self.answer_entry = ttk.Entry(answering_frame, font=("Cambria", 30), width=20)
        ...
        self.feedback_label = ttk.Label(self, font=("Cambria", 25))
...
class ResultsScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.title_label = ttk.Label(title_frame, font=("Berlin Sans FB", 50))
        self.title_label.pack()

        # Create subheader.
        self.subheader_text = ttk.Label(title_frame, font=("Cambria", 25))
        ...
        # Top bar and contents frame.
        topbar = tk.Frame(self.main_frame, borderwidth=3, relief="solid")
        topbar.grid(row=0, column=0, sticky="ew")

        # Contents frame.
        contents_frame = tk.Frame(self.main_frame, borderwidth=3, relief="solid")
        contents_frame.grid(row=1, column=0, sticky="nsew")
        ...
        # Create main frame header (goes in topbar).
        self.mainframe_header = ttk.Label(topbar, font=("Arial", 25))
        self.mainframe_header.pack(pady=5)

        # Create frame for 'Score'.
        score_frame = tk.Frame(contents_frame, borderwidth=1, relief="solid", width=250, height=101)
        score_frame.grid(row=0, column=0, sticky="nsew")
        score_frame.grid_propagate(False)

        # Create 'Score' header.
        score_header = ttk.Label(score_frame, text="Score", font=("Arial", 25, "underline"))
        score_header.pack(pady=5)

        # Create 'Score' label.
        self.score_label = ttk.Label(score_frame, font=("Arial", 25))
        self.score_label.pack(pady=(0, 5))

        # Create frame for 'Time Remaining'.
        time_frame = tk.Frame(contents_frame, borderwidth=1, relief="solid", width=250, height=101)
        time_frame.grid(row=0, column=1, sticky="nsew")
        time_frame.grid_propagate(False)

        # Create 'Time Remaining' header.
        time_header = ttk.Label(time_frame, text="Time Remaining", font=("Arial", 25, "underline"))
        time_header.pack(pady=5)

        # Create 'Time Remaining' label.
        self.time_label = ttk.Label(time_frame, font=("Arial", 25))
        self.time_label.pack(pady=(0, 5))

        # Create frame for 'Date & Time'.
        datetime_frame = tk.Frame(contents_frame, borderwidth=1, relief="solid", width=500, height=101)
        datetime_frame.grid(row=0, column=2, sticky="nsew")
        datetime_frame.grid_propagate(False)

        # Create 'Date & Time' header.
        datetime_header = ttk.Label(datetime_frame, text="Date & Time", font=("Arial", 25, "underline"))
        datetime_header.pack(pady=5)

        # Create 'Date & Time' label.
        self.datetime_label = ttk.Label(datetime_frame, font=("Arial", 25))
        self.datetime_label.pack(pady=(0, 5))

        # Label for motivational message.
        self.motivational_message = ttk.Label(self, font=("Arial", 30))
    ...
    def return_to_lobby(self):
        ...
        # Remove (hide) main frame and motivational message widgets.
