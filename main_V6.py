...
class App(tk.Tk):
    ...
    def check_answer(self, user_answer):
        ...
        # Check if user has entered any leading '+' signs
...
class QuizScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        topbar.grid_columnconfigure(0, minsize=375)
        topbar.grid_columnconfigure(1, weight=1)
        topbar.grid_columnconfigure(2, minsize=375)
...
class ResultsScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        score_frame = tk.Frame(contents_frame, borderwidth=1, width=250)
        ...
        time_frame = tk.Frame(contents_frame, borderwidth=1, width=250)
        time_frame.grid(row=0, column=1)

        # Create 'Time' header
        time_header = ttk.Label(time_frame, text="Time", font=("TkDefaultFont", 25, "underline"))
        ...
        datetime_frame = tk.Frame(contents_frame, borderwidth=1, width=500)
        datetime_frame.grid(row=0, column=3)
